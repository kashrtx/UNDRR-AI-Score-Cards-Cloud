...
export function GettingStarted({
  ...
  const steps = [
    ...
    },
    {
      ...
      body: "You get a plain-language summary, strong and weak spots, a priority chart, and an action plan. Then tap Ask the advisor to sanity-check it or add your own data, and Download report or Download data to save and share.",
    },
  ];
